...
function Bookshelf({ books, changeShelf, handleShelfDragOver, handleShelfDragLeave, handleShelfDrop, dragOverShelf, handleBookDragStart, handleBookDragEnd, draggedBook, handleShowDetails }) {
  return (
